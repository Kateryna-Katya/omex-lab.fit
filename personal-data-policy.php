    ...
    <section class="pages">
        <div class="container">
            <div class="pages__header">
                ...
                <h1 class="fade-in">Политика обработки персональных данных</h1>
                
                <p class="lead-text fade-in">
                    Важнейшей целью <strong><?= $domainTitle ?></strong> является защита прав и свобод человека при обработке его персональных данных, включая защиту на неприкосновенность частной жизни.
                </p>
            </div>
            ...
            <div class="legal-content fade-in">
                <div class="legal-section">
                    ...
                    <p>
                        Настоящая политика определяет порядок и условия обработки данных платформой <strong><?= $domainTitle ?></strong> (далее — «Оператор») в соответствии с законодательством Германии и регламентом GDPR.
                    </p>
                    <p>
                        Данная Политика применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <span class="text-accent"><?= $fullDomain ?></span>.
                    </p>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <ul class="legal-list">
                        <li>
                            <div class="list-icon"><i data-lucide="globe"></i></div>
                            <div><strong>Веб-сайт:</strong> Совокупность графических и информационных материалов <?= $fullDomain ?>.</div>
                        </li>
                        <li>
                            <div class="list-icon"><i data-lucide="users"></i></div>
                            <div><strong>Пользователь:</strong> Любой посетитель нашего ресурса.</div>
                        </li>
                        <li>
                            <div class="list-icon"><i data-lucide="fingerprint"></i></div>
                            <div><strong>Персональные данные:</strong> Информация, относящаяся прямо или косвенно к Пользователю.</div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="benefits-grid">
                        <div class="benefit-item">Идентификация для доступа к платформе.</div>
                        <div class="benefit-item">Установление обратной связи по заявкам.</div>
                        <div class="benefit-item">Исполнение договоров на IT-обучение.</div>
                        <div class="benefit-item">Улучшение качества работы школы.</div>
                    </div>
                </div>

                <div class="contact-info-block fade-in">
                    <h2>6. Вопросы и отзывы</h2>
                    <p>По всем вопросам обработки данных на <strong><?= $domainTitle ?></strong> обращайтесь в наш офис в Берлине или по электронной почте:</p>
