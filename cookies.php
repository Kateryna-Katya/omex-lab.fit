    ...
    <section class="pages">
        <div class="container">
            <div class="pages__header">
                ...
                <h1 class="fade-in">Политика использования файлов cookie</h1>
                
                <p class="lead-text fade-in">
                    Добро пожаловать на <strong><?= $domainTitle ?></strong>! Чтобы улучшить ваш опыт взаимодействия с нашим сайтом, 
                    обеспечить его корректную работу и анализировать активность пользователей, мы используем файлы cookie.
                </p>
            </div>
            ...
            <div class="legal-content fade-in">
                <div class="legal-section">
                    ...
                    <p>
                        Файл cookie — это небольшой фрагмент данных (текстовый файл), который веб-сайт сохраняет на вашем устройстве, 
                        когда вы его посещаете. Это позволяет платформе <span class="text-accent"><?= $domainTitle ?></span> "помнить" ваши действия 
                        и предпочтения (логин, язык, настройки региона Германия) в течение определенного времени.
                    </p>
                </div>

                <div class="legal-section">
                    <h2>Какие типы файлов cookie мы используем?</h2>
                    <p>Мы классифицируем файлы cookie на сайте <strong><?= $fullDomain ?></strong> по следующим категориям:</p>
                    
                    <ul class="legal-list">
                        <li>
                            <div class="list-icon"><i data-lucide="shield-check"></i></div>
                            <div>
                                <strong>Строго необходимые:</strong> Критически важны для функционирования. 
                                Позволяют перемещаться по страницам <strong><?= $domainTitle ?></strong> и обеспечивают безопасность.
                            </div>
                        </li>
                        <li>
                            <div class="list-icon"><i data-lucide="bar-chart-3"></i></div>
                            <div>
                                <strong>Аналитические:</strong> Сбор анонимной информации о том, как посетители используют наш сайт, 
                                что помогает нам оптимизировать IT-курсы.
                            </div>
                        </li>
                        <li>
                            <div class="list-icon"><i data-lucide="settings"></i></div>
                            <div>
                                <strong>Функциональные:</strong> Позволяют запоминать ваш выбор 
                                для более персонализированного опыта в рамках обучения.
                            </div>
                        </li>
                        <li>
                            <div class="list-icon"><i data-lucide="target"></i></div>
                            <div>
                                <strong>Маркетинговые:</strong> Используются для доставки объявлений, 
                                соответствующих вашим профессиональным интересам.
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="benefits-grid">
                        <div class="benefit-item">Обеспечение стабильной работы платформы.</div>
                        <div class="benefit-item">Анализ поведения для оптимизации обучения.</div>
                        <div class="benefit-item">Персонализация контента для жителей Европы.</div>
                        <div class="benefit-item">Предоставление релевантных материалов.</div>
                    </div>
                </div>
